...
if ! kk_assert_quiet kk_assert_equals "test1" "test2" "Unequal values"; then
...
if ! kk_assert_quiet kk_assert_not_equals "test" "test" "Same values"; then
    kk_test_pass "Assertion correctly failed"
else
    kk_test_fail "Assertion should have failed"
fi
...
if ! kk_assert_quiet kk_assert_true "" "Empty string test"; then
    kk_test_pass "Assertion correctly failed"
else
    kk_test_fail "Assertion should have failed"
fi
...
if ! kk_assert_quiet kk_assert_true "false" "False string test"; then
    kk_test_pass "Assertion correctly failed"
else
    kk_test_fail "Assertion should have failed"
fi
...
if ! kk_assert_quiet kk_assert_false "non-empty" "Non-empty test"; then
    kk_test_pass "Assertion correctly failed"
else
    kk_test_fail "Assertion should have failed"
fi
